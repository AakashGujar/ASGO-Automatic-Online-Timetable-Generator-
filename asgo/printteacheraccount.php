...
$printteacheraccount=$_SESSION['printteacheraccount'];
if($printteacheraccount != "")
{
...
<form method="POST" action="printteacheraccount.php"> 
<?php
...
if($printteacheraccount != "")
{
echo '<table ><tr id=myhidediv4 style="background-color:white;border:none;"><td colspan=2 style="background-color:white;border:none;"><button style="width:50%;" type=submit name="backhome">back home page</button></td>
<td style="background-color:white;border:none;"></td>
<td colspan=2 style="background-color:white;border:none;width:10%;"><button style="width:50%;float:left;" name=print type=submit onclick="printFunction()">print</button></td></tr>
</table>';
}
