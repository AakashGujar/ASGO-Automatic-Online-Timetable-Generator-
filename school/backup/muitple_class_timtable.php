...
for($class_name_index=0;$class_name_index<12;$class_name_index++)
{
             
    $class_table_name=$class_name[$class_name_index];
    
    echo "<h4>".$class_table_name."<h4>";
 ...
 <table border="2px" width="100%">
   ...
   $timming_count=count($timming);
    ...
    {
         unset($srno,$day_wise_id,$class_available,$timming_id,$teacher_name,$lecture_name,$lecture_type,$lecture_place,$row_span,$batch);
