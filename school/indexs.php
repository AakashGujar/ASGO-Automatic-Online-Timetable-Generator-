    ...
    <--<div class="" id="">
        ...
        <div class="" id="">
            ...
            <form method="post" target="_self" action="insert_information.php">
                ...
                <button type="submit" name="lecture_place_detail" id="lecture_place_detail">Lecture Place
                    Name</button><br><br>
        ...
        <div class="" id="">
            ...
            <form method="post" target="_self" action="class_lecture_detail.php">
                ...
                <button type="submit" name="class_time_detail" id="new_detail">New Details</button><br><br>
